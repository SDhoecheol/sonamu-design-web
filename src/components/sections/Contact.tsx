            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-stretch">
                    <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-white p-8 pt-12 rounded-[2.5rem] shadow-sm border border-gray-100 flex flex-col justify-start h-[260px]">
                    ...
                    <div className="lg:col-span-3 min-h-[530px] rounded-[3.5rem] shadow-xl overflow-hidden border border-gray-100"><div id="map" className="w-full h-full bg-gray-200"></div></div>
                </div>
            </div>
        </section>
  );
